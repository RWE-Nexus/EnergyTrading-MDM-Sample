    ...
    public class LegalEntitySearchResultsViewModel : NotificationObject, IActiveAware
    {
        ...
        public ObservableCollection<LegalEntityViewModel> LegalEntitys
        {
            ...
            set
            {
                ...
                if (LegalEntitys != null && LegalEntitys.Count > 0 && SelectedLegalEntity == null) SelectedLegalEntity = LegalEntitys[0];            }
        }
        ...
        public void NavigateToDetail(object sender, KeyEventArgs e)
        {
            ...
            {
                this.navigationService.NavigateMain(new LegalEntityEditUri(this.SelectedLegalEntity.Id.Value, this.search.AsOf.Value));
            }
        }
                        ...
                        this.LegalEntitys =
                            new ObservableCollection<LegalEntityViewModel>(
                                searchResults.Select(
                                    x =>
                                    new LegalEntityViewModel(new EntityWithETag<LegalEntity>(x, null), this.eventAggregator)).OrderBy(y => y.Name));
                    }, 
