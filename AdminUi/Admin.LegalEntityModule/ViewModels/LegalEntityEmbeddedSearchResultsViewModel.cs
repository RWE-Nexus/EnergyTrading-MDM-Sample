...
namespace Admin.LegalEntityModule.ViewModels
{
    ...
    public class LegalEntityEmbeddedSearchResultsViewModel : NotificationObject, IActiveAware
    {
                                ...
                                new ObservableCollection<LegalEntityViewModel>(
                                    searchResults.Select(
                                        ...
                                        new LegalEntityViewModel(
                                            new EntityWithETag<LegalEntity>(x, null), this.eventAggregator)).
                                        OrderBy(y => y.Name));
                        },
        ...
        IRegion MyRegion(IRegionCollection regions)
        {
            ...
            {
                if (regions.ElementAt(i).Name.EndsWith("-LegalEntitySearchResultsRegion") && regions.ElementAt(i).Context != null)
                {
