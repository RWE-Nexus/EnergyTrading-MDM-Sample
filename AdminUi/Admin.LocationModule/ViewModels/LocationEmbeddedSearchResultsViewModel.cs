...
namespace Admin.LocationModule.ViewModels
{
    ...
    public class LocationEmbeddedSearchResultsViewModel : NotificationObject, IActiveAware
    {
                                ...
                                new ObservableCollection<LocationViewModel>(
                                    searchResults.Select(
                                        ...
                                        new LocationViewModel(
                                            new EntityWithETag<Location>(x, null), this.eventAggregator)).
                                        OrderBy(y => y.Name));
                        },
        ...
        IRegion MyRegion(IRegionCollection regions)
        {
            ...
            {
                if (regions.ElementAt(i).Name.EndsWith("-LocationSearchResultsRegion") && regions.ElementAt(i).Context != null)
                {
