...
namespace Admin.ExchangeModule.ViewModels
{
    ...
    public class ExchangeEditViewModel : NotificationObject, IConfirmNavigationRequest
    {
        ...
        private void UpdateMapping(object mapping)
        {
            ...
            if (mappingViewModel != null)
            {
                this.eventAggregator.Publish(new MappingUpdateEvent(this.Exchange.Id.Value, mappingViewModel.MappingId.Value, mappingViewModel.MappingString, "Exchange"));
            }
        }
            ...
            if (this.SelectedMapping != null && CanEditOrDeleteMapping(this.SelectedMapping))
            {
                if (!this.SelectedMapping.IsMdmId)
                {
                    this.navigationService.NavigateMain(
                        new MappingEditUri(
                            this.Exchange.Id.Value, "Exchange", Convert.ToInt32(this.SelectedMapping.MappingId), this.Exchange.Name));
                    return;
                }
        ...
        public void OnNavigatedFrom(NavigationContext navigationContext)
        {
            ...
            this.applicationCommands.CloseView("ProductEmbeddedSearchResultsView", "Exchange-ProductSearchResultsRegion");
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            if (this.Exchange == null || this.validAtString != validAtStringParam ||
                this.Exchange.Id != idParam)
            {
                this.ShowProducts = false;
                this.applicationCommands.CloseView("ProductEmbeddedSearchResultsView", "Exchange-ProductSearchResultsRegion");
            ...
            this.applicationCommands.OpenView("ProductEmbeddedSearchResultsView", "Exchange-ProductSearchResultsRegion", idParam, validAtStringParam, "Exchange");
        ...
        {
            this.navigationService.NavigateMain(new MappingAddUri(this.Exchange.Id.Value, "Exchange", this.Exchange.Name));
        }
        ...
        private void LoadExchangeFromService(int exchangeId, DateTime validAt, bool publishChangeNotification = false)
        {
            this.entityService.ExecuteAsync(
                ...
                (response) =>
                {
                    this.Exchange = new ExchangeViewModel(new EntityWithETag<Exchange>(response.Message, response.Tag), this.eventAggregator);
