    ...
    public class SourceSystemEditViewModel : NotificationObject, IConfirmNavigationRequest
    {
        ...
        public void OnNavigatedFrom(NavigationContext navigationContext)
        {
            ...
            this.applicationCommands.CloseView(
                ...
                "SourceSystem-SourceSystemSearchResultsRegion");
        }
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            if (this.SourceSystem == null || this.validAtString != validAtStringParam || this.SourceSystem.Id != idParam)
            {
                this.ShowSourceSystems = false;
                this.applicationCommands.CloseView(
                    "SourceSystemEmbeddedSearchResultsView", 
        ...
        private void MappingDeleteConfirmed(MappingDeleteConfirmedEvent obj)
        {
            ...
            var response = this.mappingService.DeleteMapping("SourceSystem", obj.MappingId, this.SourceSystem.Id.Value);
