...
namespace Admin.SourceSystemModule.Uris
{
    ...
    public class SourceSystemEditUri : Uri
    {
        public SourceSystemEditUri(int sourcesystemId, DateTime validAt) : 
            base(SourceSystemViewNames.SourceSystemEditView + string.Format("?{0}={1}&{2}={3}", NavigationParameters.EntityId, sourcesystemId, NavigationParameters.ValidAtDate, validAt), UriKind.Relative)
        {
        }
    }
}
