...
namespace Admin.PartyModule
{
    ...
    public class ModuleInit : IModule
    {
        ...
        public void Initialize()
        {
            ...
            this.menuRegistry.RegisterMenuItem("Party", string.Empty, typeof(PartySearchResultsView), new Uri(PartyViewNames.PartyAddView, UriKind.Relative), "Name", "_Name");
        ...
        private void Register()
        {
            ...
            this.container.RegisterType<object, PartyEmbeddedSearchResultsView>(PartyViewNames.PartyEmbeddedSearchResultsView, new ContainerControlledLifetimeManager());
            ...
            this.container.RegisterInstance<Func<int, IMdmEntity>>("Party",
                (entityId) =>
                    {
