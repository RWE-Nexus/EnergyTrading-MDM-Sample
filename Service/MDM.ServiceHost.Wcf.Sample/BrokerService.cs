namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class BrokerService : EntityService<EnergyTrading.MDM.Contracts.Sample.Broker, MDM.Broker>
    {
        /// <summary>
        ...
        public void Create(Broker contract)
        {
        ...
        public IList<Broker> GetEntityList(string id)
        {
        ...
        public void Update(string id, Broker contract)
        {
