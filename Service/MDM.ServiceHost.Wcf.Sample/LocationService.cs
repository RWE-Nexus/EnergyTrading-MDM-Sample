namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class LocationService : EntityService<EnergyTrading.MDM.Contracts.Sample.Location, MDM.Location>
    {
        /// <summary>
        ...
        public IList<Location> GetEntityList(string id)
        {
        ...
        public void Update(string id, Location contract)
        {
