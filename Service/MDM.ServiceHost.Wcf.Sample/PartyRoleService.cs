namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class PartyRoleService : EntityService<EnergyTrading.MDM.Contracts.Sample.PartyRole, MDM.PartyRole>
    {
        /// <summary>
        ...
        public PartyRoleList List()
        {
            var list = new PartyRoleList();
        ...
        public IList<PartyRole> GetEntityList(string id)
        {
            var list = new List<PartyRole>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public PartyRole Get(string id)
        {
