namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_and_the_source_system_mapping_string_is_unkown_for_location : IntegrationTestBase
    {
