	namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_exchange_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Exchange> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Exchange> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Exchange"] + "search", content);
        ...
        private static IList<Exchange> GetPeopleFromFeed(SyndicationFeed feed)
        {
