namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_create_a_exchange_mapping : IntegrationTestBase
    {
        ...
        [Test]
        public void should_create_a_mapping_on_the_exchange_entity()
        {
            var savedMapping =
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The Exchange id returned was not an integer");
