namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_counterparty_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = CounterpartyData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["Counterparty"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
