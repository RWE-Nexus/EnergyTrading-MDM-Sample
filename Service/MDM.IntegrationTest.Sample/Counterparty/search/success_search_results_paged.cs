	namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_counterparty_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Counterparty> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Counterparty> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Counterparty"] + "search", content);
        ...
        private static IList<Counterparty> GetPeopleFromFeed(SyndicationFeed feed)
        {
