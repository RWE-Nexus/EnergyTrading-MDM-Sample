namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_retrive_a_counterparty_from_a_source_system_and_the_mapping_string_doesnt_exist : IntegrationTestBase
    {
        ...
        public void should_return_nexus_failure_with_correct_information()
        {
            ...
            Assert.That("Counterparty Mapping String 'abc' not found for Source System 'Trayport' and the given date '2010-03-16T11:21:23Z'", Is.EqualTo(fault.Message).IgnoreCase);
        }
    }
}