namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_create_a_counterparty_mapping : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["Counterparty"] + string.Format("{0}/Mapping", entity.Id), content);
        }

        [Test]
        public void should_create_a_mapping_on_the_counterparty_entity()
        {
            var savedMapping =
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The Counterparty id returned was not an integer");
