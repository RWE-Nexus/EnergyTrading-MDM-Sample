namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_update_a_party_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static PartyMapping currentTrayportMapping;
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Party"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var partyMapping = new DbSetRepository(new DbContextProvider(() => new SampleMappingContext())).FindOne<MDM.PartyMapping>(entity.Mappings[0].Id);
            return partyMapping.Version.ToUnsignedLongVersion();
        }
    }
}
