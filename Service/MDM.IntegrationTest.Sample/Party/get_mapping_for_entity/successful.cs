namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_party : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
        private static Party entity;
        private static PartyMapping mapping;
        ...
        protected static void Because_of()
        {
            ...
            client = new HttpClient(ServiceUrl["Party"] + string.Format("{0}/mapping/{1}", entity.Id, mapping.Id));
