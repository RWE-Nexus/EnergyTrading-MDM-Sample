namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_and_no_mapping_exists_for_the_destination_system_for_broker : IntegrationTestBase
    {
