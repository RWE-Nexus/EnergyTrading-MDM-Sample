	namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_broker_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Broker> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Broker> pageTwo;
        ...
        private static IList<Broker> GetPeopleFromFeed(SyndicationFeed feed)
        {
