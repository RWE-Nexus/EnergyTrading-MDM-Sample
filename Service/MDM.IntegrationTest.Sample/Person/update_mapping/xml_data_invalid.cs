namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_update_a_person_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        [Test]
        public void should_not_update_the_person_mapping_in_the_database()
        {
        ...
        {
            return new DbSetRepository(new DbContextProvider(() => new SampleMappingContext())).FindOne<MDM.PersonMapping>(entity.Mappings[0].Id).Version.ToUnsignedLongVersion();
        }
    }
}
