namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_partyrole_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            var notAMapping = new MDM.PartyRole();
        ...
        [TestMethod]
        public void should_not_update_the_partyrole_mapping_in_the_database()
        {
