namespace EnergyTrading.MDM.Test
{
    ...
    {
        private static IList<OpenNexus.MDM.Contracts.PartyRole> returnedPartyRoles;
        ...
        {
            IList<EnergyTrading.Mdm.Contracts.MdmId> entityIds = returnedPartyRoles.Select(x => x.Identifiers.First(id => id.IsMdmId)).ToList();
