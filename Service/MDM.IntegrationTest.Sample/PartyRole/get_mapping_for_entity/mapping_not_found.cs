namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_partyrole_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = PartyRoleData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["PartyRole"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
