namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_partyrole_mapping_and_a_conflicting_mapping_exists : IntegrationTestBase
    {
        ...
        {
            client.Post(ServiceUrl["PartyRole"] + string.Format("{0}/Mapping", entity.Id), content);
            response2 = client.Post(ServiceUrl["PartyRole"] + string.Format("{0}/Mapping", entity.Id), content2);
        }
