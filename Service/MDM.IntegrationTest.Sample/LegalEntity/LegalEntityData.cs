namespace EnergyTrading.MDM.Test
{
    ...
    public static class LegalEntityData
    {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.LegalEntity CreateContractForEntityCreation()
        {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.LegalEntity MakeChangeToContract(EnergyTrading.MDM.Contracts.Sample.LegalEntity currentContract)
        {
            var entity = ObjectMother.Create<LegalEntity>();
            repository.Add(entity);
            repository.Flush();

            currentContract.Details = new EnergyTrading.MDM.Contracts.Sample.LegalEntityDetails()
            {
        ...
        private static void AddDetailsToContract(EnergyTrading.MDM.Contracts.Sample.LegalEntity contract)
        {
            var entity = ObjectMother.Create<LegalEntity>();
            repository.Add(entity);
            repository.Flush();

            contract.Details = new EnergyTrading.MDM.Contracts.Sample.LegalEntityDetails()
            {
                Name = entity.LatestDetails.Name,
                Phone = (entity.LatestDetails as LegalEntityDetails).Phone,
            };
