namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_update_a_legalentity_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            var notAMapping = new MDM.LegalEntity();
        ...
        [Test]
        public void should_not_update_the_legalentity_mapping_in_the_database()
        {
