    namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_legalentity_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<LegalEntity> pageOne;
        private static Uri pageOneNextPage;
        private static IList<LegalEntity> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["LegalEntity"] + "search", content);
        ...
        private static IList<LegalEntity> GetPeopleFromFeed(SyndicationFeed feed)
        {
