namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestFixture]
    public class LegalEntityCrossMapFixture
    {
        [Test]
        ...
        public void SuccessMatch()
        {
            ...
            var legalentity = new MDM.LegalEntity
            {
                Id = 1,
            };
            //LegalEntity.AddDetails(details);
            legalentity.ProcessMapping(mapping);
            legalentity.ProcessMapping(targetMapping);
