namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestFixture]
    public class CounterpartyCrossMapFixture
    {
        [Test]
        ...
        public void SuccessMatch()
        {
            ...
            var details = new MDM.CounterpartyDetails
                {
                    Name = "Test",
                };
            var counterparty = new MDM.Counterparty
                {
                    Id = 1
                };
            counterparty.AddDetails(details);
            counterparty.ProcessMapping(mapping);
            counterparty.ProcessMapping(targetMapping);
