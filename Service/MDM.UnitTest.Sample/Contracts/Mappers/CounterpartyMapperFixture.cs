...
namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestFixture]
    public class CounterpartyMapperFixture : Fixture
    {
        [Test]
        public void Map()
        {
            ...
            var contractDetails = new EnergyTrading.MDM.Contracts.Sample.CounterpartyDetails();
            ...
            var details = new CounterpartyDetails();
            ...
            mappingEngine.Setup(x => x.Map<EnergyTrading.MDM.Contracts.Sample.CounterpartyDetails, CounterpartyDetails>(contractDetails)).Returns(details);
            repository.Setup(x => x.FindOne<Party>(int.Parse(contract.Party.Identifier.Identifier))).Returns(ObjectMother.Create<Party>());

            var mapper = new CounterpartyMapper(mappingEngine.Object, repository.Object);
            ...
            Assert.AreEqual("Counterparty", candidate.PartyRoleType);
