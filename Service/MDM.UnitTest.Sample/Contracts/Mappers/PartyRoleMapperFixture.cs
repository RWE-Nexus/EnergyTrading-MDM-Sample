namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestFixture]
    public class PartyRoleMapperFixture : Fixture
    {
        [Test]
        public void Map()
        {
            ...
            var contractDetails = new EnergyTrading.MDM.Contracts.Sample.PartyRoleDetails();
            ...
            mappingEngine.Setup(x => x.Map<EnergyTrading.MDM.Contracts.Sample.PartyRoleDetails, PartyRoleDetails>(contractDetails)).Returns(details);
            repository.Setup(x => x.FindOne<Party>(int.Parse(contract.Party.Identifier.Identifier))).Returns(ObjectMother.Create<Party>());

            var mapper = new PartyRoleMapper(mappingEngine.Object, repository.Object);
