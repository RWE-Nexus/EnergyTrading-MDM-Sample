namespace EnergyTrading.MDM.Test
{
    ...
    public static class CounterpartyData
    {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.Counterparty CreateContractForEntityCreation()
        {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.Counterparty MakeChangeToContract(EnergyTrading.MDM.Contracts.Sample.Counterparty currentContract)
        {
            var entity = ObjectMother.Create<Counterparty>();
            repository.Add(entity);
            repository.Flush();

            currentContract.Details = new EnergyTrading.MDM.Contracts.Sample.CounterpartyDetails()
                {
        ...
        private static void AddDetailsToContract(EnergyTrading.MDM.Contracts.Sample.Counterparty contract)
        {
            var entity = ObjectMother.Create<Counterparty>();
            repository.Add(entity);
            repository.Flush();

            contract.Details = new EnergyTrading.MDM.Contracts.Sample.CounterpartyDetails()
                {
                    Name = entity.LatestDetails.Name,
                    Phone = (entity.LatestDetails as CounterpartyDetails).Phone,
                    Fax = (entity.LatestDetails as CounterpartyDetails).Fax,
