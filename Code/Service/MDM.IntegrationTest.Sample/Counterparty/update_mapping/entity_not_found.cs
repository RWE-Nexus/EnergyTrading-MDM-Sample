namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_update_a_counterparty_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Counterparty"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var counterpartyMapping = new DbSetRepository(new DbContextProvider(() => new SampleMappingContext())).FindOne<MDM.PartyRoleMapping>(entity.Mappings[0].Id);
            return counterpartyMapping.Version.ToUnsignedLongVersion();
        }
    }
}
