namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_person_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["Person"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = Script.PersonData.CreateBasicEntityWithOneMapping();
            entity2 = Script.PersonData.CreateBasicEntityWithOneMapping();
    ...
    [TestFixture]
    public class when_a_search_for_a_person_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
