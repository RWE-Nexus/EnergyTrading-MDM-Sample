namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_create_a_person_mapping : IntegrationTestBase
    {
        ...
        [Test]
        public void should_create_a_mapping_on_the_person_entity()
        {
            var savedMapping =
                new DbSetRepository(new DbContextProvider(() => new SampleMappingContext())).FindOne<MDM.PersonMapping>(int.Parse(GetLocationHeader()[3]));
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The Person id returned was not an integer");
