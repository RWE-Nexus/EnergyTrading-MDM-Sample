namespace EnergyTrading.MDM.Test 
{
    ...
    [TestFixture]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_for_person : IntegrationTestBase
    {
        ...
        {
            entity = Script.PersonData.CreateEntityWithTwoDetailsAndTwoMappings();
    ...
    [TestFixture]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_as_of_a_date_for_person : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
