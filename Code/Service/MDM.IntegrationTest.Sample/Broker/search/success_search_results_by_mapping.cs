namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_broker_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            entity1 = BrokerData.CreateBasicEntityWithOneMapping();
            entity2 = BrokerData.CreateBasicEntityWithOneMapping();
    ...
    [TestFixture]
    public class when_a_search_for_a_broker_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
