namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_sourcesystem_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        {
            return new DbSetRepository(new DbContextProvider(() => new SampleMappingContext())).FindOne<MDM.SourceSystemMapping>(entity.Mappings[0].Id).Version.ToUnsignedLongVersion();
        }
    }
}
