namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_exchange_entity : IntegrationTestBase
    {
        ...
        private static EnergyTrading.MDM.Contracts.Sample.Exchange exchangeDataContract;
        private static HttpClient client;
        private static MDM.Exchange entity;

        private static EnergyTrading.MDM.Contracts.Sample.Exchange updatedContract;
