namespace EnergyTrading.MDM.Test
{
    ...
    public static class ExchangeData
    {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.Exchange CreateContractForEntityCreation()
        {
        ...
        public static EnergyTrading.MDM.Contracts.Sample.Exchange MakeChangeToContract(EnergyTrading.MDM.Contracts.Sample.Exchange currentContract)
        {
            var entity = ObjectMother.Create<Exchange>();
            repository.Add(entity);
            repository.Flush();

            currentContract.Details = new EnergyTrading.MDM.Contracts.Sample.ExchangeDetails()
                {
