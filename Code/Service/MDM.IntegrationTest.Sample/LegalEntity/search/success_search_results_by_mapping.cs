namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_legalentity_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            entity1 = LegalEntityData.CreateBasicEntityWithOneMapping();
            entity2 = LegalEntityData.CreateBasicEntityWithOneMapping();
    ...
    [TestFixture]
    public class when_a_search_for_a_legalentity_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
