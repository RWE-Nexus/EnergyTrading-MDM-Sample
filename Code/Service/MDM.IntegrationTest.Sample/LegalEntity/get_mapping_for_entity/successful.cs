namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_legalentity : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
        private static LegalEntity entity;
        private static PartyRoleMapping mapping;
        ...
        protected static void Because_of()
        {
            ...
            client = new HttpClient(ServiceUrl["LegalEntity"] + string.Format("{0}/mapping/{1}", entity.Id, mapping.Id));
