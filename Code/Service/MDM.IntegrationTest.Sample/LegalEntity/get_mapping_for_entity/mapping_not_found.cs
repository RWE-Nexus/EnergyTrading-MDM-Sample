namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_legalentity_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = LegalEntityData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["LegalEntity"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
