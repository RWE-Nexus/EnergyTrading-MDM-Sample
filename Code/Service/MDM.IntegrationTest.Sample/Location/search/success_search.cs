namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_location_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = Script.LocationData.CreateBasicEntity();
            var entity2 = Script.LocationData.CreateBasicEntity();
