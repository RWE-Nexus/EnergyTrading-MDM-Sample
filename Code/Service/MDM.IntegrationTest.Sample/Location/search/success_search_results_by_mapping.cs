namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_location_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            entity1 = Script.LocationData.CreateBasicEntityWithOneMapping();
            entity2 = Script.LocationData.CreateBasicEntityWithOneMapping();
    ...
    [TestFixture]
    public class when_a_search_for_a_location_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
