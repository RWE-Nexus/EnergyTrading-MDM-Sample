namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_location_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = Script.LocationData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["Location"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
