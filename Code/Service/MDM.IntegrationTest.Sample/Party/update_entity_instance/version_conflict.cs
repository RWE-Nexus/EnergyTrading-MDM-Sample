namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_request_is_made_to_update_a_party_entity_and_the_etag_is_not_current : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            content = HttpContentExtensions.CreateDataContract(new EnergyTrading.MDM.Contracts.Sample.Party());
