namespace EnergyTrading.MDM.Test
{
    ...
    [TestFixture]
    public class when_a_search_for_a_party_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        public void should_return_the_relevant_search_results()
        {
            ...
            List<EnergyTrading.MDM.Contracts.Sample.Party> result =
                feed.Items.Select(syndicationItem => (XmlSyndicationContent)syndicationItem.Content).Select(
                    syndic => syndic.ReadContent<EnergyTrading.MDM.Contracts.Sample.Party>()).ToList();
        ...
        protected static void Establish_context()
        {
            ...
            entity2 = Script.PartyData.CreateBasicEntityWithOneMapping();
    ...
    [TestFixture]
    public class when_a_search_for_a_party_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
