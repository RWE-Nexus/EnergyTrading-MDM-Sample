namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class SourceSystemService : EntityService<SourceSystem, MDM.SourceSystem>
    {
        /// <summary>
        ...
        public void Create(SourceSystem contract)
        {
        ...
        public SourceSystemList List()
        {
            var list = new SourceSystemList();
        ...
        public IList<SourceSystem> GetEntityList(string id)
        {
            var list = new List<SourceSystem>();
        ...
        public void Update(string id, SourceSystem contract)
        {
