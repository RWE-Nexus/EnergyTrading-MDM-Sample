namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class PartyService : EntityService<EnergyTrading.MDM.Contracts.Sample.Party, MDM.Party>
    {
        /// <summary>
        ...
        public void Create(Party contract)
        {
        ...
        public IList<Party> GetEntityList(string id)
        {
        ...
        public void Update(string id, Party contract)
        {
