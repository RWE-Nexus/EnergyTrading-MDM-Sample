namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class PersonService : EntityService<EnergyTrading.MDM.Contracts.Sample.Person, MDM.Person>
    {
        /// <summary>
        ...
        public void Create(Person contract)
        {
        ...
        public IList<Person> GetEntityList(string id)
        {
        ...
        public void Update(string id, Person contract)
        {
