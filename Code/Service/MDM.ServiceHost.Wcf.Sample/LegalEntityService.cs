namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class LegalEntityService : EntityService<EnergyTrading.MDM.Contracts.Sample.LegalEntity, MDM.LegalEntity>
    {
        /// <summary>
        ...
        public void Create(LegalEntity contract)
        {
        ...
        public LegalEntityList List()
        {
            var list = new LegalEntityList();
        ...
        public IList<LegalEntity> GetEntityList(string id)
        {
        ...
        public void Update(string id, LegalEntity contract)
        {
