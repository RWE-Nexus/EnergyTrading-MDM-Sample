namespace EnergyTrading.MDM.ServiceHost.Wcf.Sample
{
    ...
    public class CounterpartyService : EntityService<EnergyTrading.MDM.Contracts.Sample.Counterparty, MDM.Counterparty>
    {
        /// <summary>
        ...
        public void Create(Counterparty contract)
        {
        ...
        public IList<Counterparty> GetEntityList(string id)
        {
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public Counterparty Get(string id)
        {
        ...
        public void Update(string id, Counterparty contract)
        {
