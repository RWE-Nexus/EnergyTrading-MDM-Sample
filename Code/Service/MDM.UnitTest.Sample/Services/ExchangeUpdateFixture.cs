namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class ExchangeUpdateFixture
    {
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new EnergyTrading.MDM.Contracts.Sample.ExchangeDetails { Name = "Exchange 1" };
            var nexus = new EnergyTrading.Mdm.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new EnergyTrading.MDM.Contracts.Sample.Exchange { Details = cd, MdmSystemData = nexus };
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = new ExchangeDetails { Id = 1, Name = "Exchange 1", Timestamp = 74UL.GetVersionByteArray() };
            ...
            mappingEngine.Setup(x => x.Map<EnergyTrading.MDM.Contracts.Sample.ExchangeDetails, ExchangeDetails>(cd)).Returns(d2);
