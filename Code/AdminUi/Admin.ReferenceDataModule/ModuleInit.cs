    ...
    public class ModuleInit : IModule
    {
        ...
        public void Initialize()
        {
            ...
            this.menuRegistry.RegisterMenuItem(
                "ReferenceData", 
                string.Empty, 
                typeof(ReferenceDataSearchResultsView), 
                new Uri(ReferenceDataViewNames.ReferenceDataAddView, UriKind.Relative), 
                "ReferenceKey", 
                "Reference _Key");
        }
        ...
        private void Register()
        {
            ...
            this.container.RegisterType<object, ReferenceDataSearchResultsView>(
                ReferenceDataViewNames.ReferenceDataSearchResultsView);
